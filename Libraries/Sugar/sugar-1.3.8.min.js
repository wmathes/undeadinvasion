...
(function () {
    ...
    F(q, k, n, {
        find: function (a, b, c) { return Ga(this, a, b, c) }, findAll: function (a, b, c) { var d = []; T(this, function (e, f, h) { Ea(e, a, h, [e, f, h]) && d.push(e) }, b, c); return d }, findIndex: function (a, b, c) { a = Ga(this, a, b, c, k); return N(a) ? -1 : a }, count: function (a) { if (N(a)) return this.length; return this.findAll(a).length }, removeAt: function (a, b) { var c, d; if (N(a)) return this; if (N(b)) b = a; c = 0; for (d = b - a; c <= d; c++) this.splice(a, 1); return this }, include: function (a, b) { return this.clone().add(a, b) }, exclude: function () {
            return q.prototype.remove.apply(this.clone(),
            arguments)
        }, clone: function () { return oa([], this) }, unique: function (a) { return Ha(this, a) }, flatten: function (a) { return La(this, a) }, union: function () { return Ha(this.concat(Ma(arguments))) }, intersect: function () { return Ja(this, Ma(arguments), n) }, subtract: function () { return Ja(this, Ma(arguments), k) }, at: function () { return ya(this, arguments) }, first: function (a) { if (N(a)) return this[0]; if (a < 0) a = 0; return this.slice(0, a) }, last: function (a) {
            if (N(a)) return this[this.length - 1]; return this.slice(this.length - a < 0 ? 0 : this.length -
            a)
        }, from: function (a) { return this.slice(a) }, to: function (a) { if (N(a)) a = this.length; return this.slice(0, a) }, min: function (a, b) { return Na(this, a, "min", b) }, max: function (a, b) { return Na(this, a, "max", b) }, least: function (a, b) { return Na(this.groupBy.apply(this, [a]), "length", "min", b) }, most: function (a, b) { return Na(this.groupBy.apply(this, [a]), "length", "max", b) }, sum: function (a) { a = a ? this.map(a) : this; return a.length > 0 ? a.reduce(function (b, c) { return b + c }) : 0 }, average: function (a) {
            a = a ? this.map(a) : this; return a.length > 0 ?
            a.sum() / a.length : 0
        }, inGroups: function (a, b) { var c = arguments.length > 1, d = this, e = [], f = O(this.length / a, void 0, "ceil"); qa(0, a - 1, function (h) { h = h * f; var i = d.slice(h, h + f); c && i.length < f && qa(1, f - i.length, function () { i = i.add(b) }); e.push(i) }); return e }, inGroupsOf: function (a, b) { var c = [], d = this.length, e = this, f; if (d === 0 || a === 0) return e; if (N(a)) a = 1; if (N(b)) b = l; qa(0, O(d / a, void 0, "ceil") - 1, function (h) { for (f = e.slice(a * h, a * h + a) ; f.length < a;) f.push(b); c.push(f) }); return c }, isEmpty: function () {
            return this.compact().length ==
            0
        }, sortBy: function (a, b) { var c = this.clone(); c.sort(function (d, e) { var f, h; f = S(d, a, c, [d]); h = S(e, a, c, [e]); if (C(f) && C(h)) { f = f; h = h; var i, j, g, m, o = 0, x = 0; f = Oa(f); h = Oa(h); do { g = Ra(f, o); m = Ra(h, o); i = Ta(g); j = Ta(m); if (i === -1 || j === -1) { i = f.charCodeAt(o) || l; j = h.charCodeAt(o) || l } g = g !== f.charAt(o); m = m !== h.charAt(o); if (g !== m && x === 0) x = g - m; o += 1 } while (i != l && j != l && i === j); f = i === j ? x : i < j ? -1 : 1 } else f = f < h ? -1 : f > h ? 1 : 0; return f * (b ? -1 : 1) }); return c }, randomize: function () {
            for (var a = this.concat(), b = a.length, c, d; b;) {
                c = v.random() * b | 0;
                d = a[--b]; a[b] = a[c]; a[c] = d
            } return a
        }, zip: function () { var a = K(arguments); return this.map(function (b, c) { return [b].concat(a.map(function (d) { return c in d ? d[c] : l })) }) }, sample: function (a) { var b = this.randomize(); return arguments.length > 0 ? b.slice(0, a) : b[0] }, each: function (a, b, c) { T(this, a, b, c); return this }, add: function (a, b) { if (!B(u(b)) || isNaN(b)) b = this.length; q.prototype.splice.apply(this, [b, 0].concat(a)); return this }, remove: function () {
            var a, b = this; K(arguments, function (c) {
                for (a = 0; a < b.length;) if (Ea(b[a], c, b,
                [b[a], a, b])) b.splice(a, 1); else a++
            }); return b
        }, compact: function (a) { var b = []; T(this, function (c) { if (ea(c)) b.push(c.compact()); else if (a && c) b.push(c); else !a && c != l && c.valueOf() === c.valueOf() && b.push(c) }); return b }, groupBy: function (a, b) { var c = this, d = {}, e; T(c, function (f, h) { e = S(f, a, c, [f, h, c]); d[e] || (d[e] = []); d[e].push(f) }); b && G(d, b); return d }, none: function () { return !this.any.apply(this, arguments) }
    }); F(q, k, n, { all: q.prototype.every, any: q.prototype.some, insert: q.prototype.add });
    ...
    (function () {
        q[Ua] = "A\u00c1\u00c0\u00c2\u00c3\u0104BC\u0106\u010c\u00c7D\u010e\u00d0E\u00c9\u00c8\u011a\u00ca\u00cb\u0118FG\u011eH\u0131I\u00cd\u00cc\u0130\u00ce\u00cfJKL\u0141MN\u0143\u0147\u00d1O\u00d3\u00d2\u00d4PQR\u0158S\u015a\u0160\u015eT\u0164U\u00da\u00d9\u016e\u00db\u00dcVWXY\u00ddZ\u0179\u017b\u017d\u00de\u00c6\u0152\u00d8\u00d5\u00c5\u00c4\u00d6".split("").map(function (b) { return b + b.toLowerCase() }).join(""); var a = {}; T("A\u00c1\u00c0\u00c2\u00c3\u00c4,C\u00c7,E\u00c9\u00c8\u00ca\u00cb,I\u00cd\u00cc\u0130\u00ce\u00cf,O\u00d3\u00d2\u00d4\u00d5\u00d6,S\u00df,U\u00da\u00d9\u00db\u00dc".split(","),
        function (b) { var c = b.charAt(0); T(b.slice(1).split(""), function (d) { a[d] = c; a[d.toLowerCase()] = c.toLowerCase() }) }); q[Pa] = k; q[Sa] = a
    })(); Wa(Xa); Wa(Ya, k); za(Za, pa);
    ...
    { ba: "hh?|hours|12hr", format: function (a) { a = W(a, "Hours"); return a === 0 ? 12 : a - ra(a / 13) * 12 } }, { ba: "HH?|24hr", format: function (a) { return W(a, "Hours") } }, { ba: "dd?|date|day", format: function (a) { return W(a, "Date") } }, { ba: "dow|weekday", la: k, format: function (a, b, c) { a = W(a, "Day"); return b.weekdays[a + (c - 1) * 7] } }, { ba: "MM?", format: function (a) { return W(a, "Month") + 1 } }, { ba: "mon|month", la: k, format: function (a, b, c) { a = W(a, "Month"); return b.months[a + (c - 1) * 12] } }, { ba: "y{2,4}|year", format: function (a) { return W(a, "FullYear") } }, {
        ba: "[Tt]{1,2}",
        format: function (a, b, c, d) { if (b.ampm.length == 0) return ""; a = W(a, "Hours"); b = b.ampm[ra(a / 12)]; if (d.length === 1) b = b.slice(0, 1); if (d.slice(0, 1) === "T") b = b.toUpperCase(); return b }
    }, { ba: "z{1,4}|tz|timezone", text: k, format: function (a, b, c, d) { a = a.getUTCOffset(); if (d == "z" || d == "zz") a = a.replace(/(\d{2})(\d{2})/, function (e, f) { return P(f, d.length) }); return a } }, { ba: "iso(tz|timezone)", format: function (a) { return a.getUTCOffset(k) } }, { ba: "ord", format: function (a) { a = W(a, "Date"); return a + ta(a) } }], jb = [{
        $: "year", method: "FullYear",
        ja: k, da: function (a) { return (365 + (a ? a.isLeapYear() ? 1 : 0 : 0.25)) * 24 * 60 * 60 * 1E3 }
    }, { $: "month", method: "Month", ja: k, da: function (a, b) { var c = 30.4375, d; if (a) { d = a.daysInMonth(); if (b <= d.days()) c = d } return c * 24 * 60 * 60 * 1E3 }, error: 0.919 }, { $: "week", method: "ISOWeek", da: aa(6048E5) }, { $: "day", method: "Date", ja: k, da: aa(864E5) }, { $: "hour", method: "Hours", da: aa(36E5) }, { $: "minute", method: "Minutes", da: aa(6E4) }, { $: "second", method: "Seconds", da: aa(1E3) }, { $: "millisecond", method: "Milliseconds", da: aa(1) }], kb = {};
    function lb(a) { oa(this, a); this.ga = hb.concat() }
    lb.prototype = {
        getMonth: function (a) { return B(a) ? a - 1 : this.months.indexOf(a) % 12 }, getWeekday: function (a) { return this.weekdays.indexOf(a) % 7 }, oa: function (a) { var b; return B(a) ? a : a && (b = this.numbers.indexOf(a)) !== -1 ? (b + 1) % 10 : 1 }, ua: function (a) { var b = this; return a.replace(r(this.num, "g"), function (c) { return b.oa(c) || "" }) }, sa: function (a) { return V.units[this.units.indexOf(a) % 8] }, va: function (a) { return this.na(a, a[2] > 0 ? "future" : "past") }, ra: function (a) { return this.na(mb(a), "duration") }, wa: function (a) {
            a = a || this.code;
            return a === "en" || a === "en-US" ? k : this.variant
        }, za: function (a) { return a === this.ampm[0] }, Aa: function (a) { return a && a === this.ampm[1] }, na: function (a, b) {
            var c, d, e = a[0], f = a[1], h = a[2], i = this[b] || this.relative; if (A(i)) return i.call(this, e, f, h, b); d = this.units[(this.plural && e > 1 ? 1 : 0) * 8 + f] || this.units[f]; if (this.capitalizeUnit) d = nb(d); c = this.modifiers.filter(function (j) { return j.name == "sign" && j.value == (h > 0 ? 1 : -1) })[0]; return i.replace(/\{(.*?)\}/g, function (j, g) {
                switch (g) {
                    case "num": return e; case "unit": return d;
                    case "sign": return c.src
                }
            })
        }, ta: function () { return this.ma ? [this.ma].concat(this.ga) : this.ga }, addFormat: function (a, b, c, d, e) {
            var f = c || [], h = this, i; a = a.replace(/\s+/g, "[-,. ]*"); a = a.replace(/\{([^,]+?)\}/g, function (j, g) {
                var m, o, x, z = g.match(/\?$/); x = g.match(/^(\d+)\??$/); var J = g.match(/(\d)(?:-(\d))?/), M = g.replace(/[^a-z]+$/, ""); if (x) m = h.tokens[x[1]]; else if (h[M]) m = h[M]; else if (h[M + "s"]) {
                    m = h[M + "s"]; if (J) {
                        o = []; m.forEach(function (Q, Da) { var U = Da % (h.units ? 8 : m.length); if (U >= J[1] && U <= (J[2] || J[1])) o.push(Q) });
                        m = o
                    } m = ob(m)
                } if (x) x = "(?:" + m + ")"; else { c || f.push(M); x = "(" + m + ")" } if (z) x += "?"; return x
            }); if (b) { b = pb(cb, h, e); e = ["t", "[\\s\\u3000]"].concat(h.timeMarker); i = a.match(/\\d\{\d,\d\}\)+\??$/); qb(h, "(?:" + b + ")[,\\s\\u3000]+?" + a, bb.concat(f), d); qb(h, a + "(?:[,\\s]*(?:" + e.join("|") + (i ? "+" : "*") + ")" + b + ")?", f.concat(bb), d) } else qb(h, a, f, d)
        }
    }; function rb(a, b) { var c; C(a) || (a = ""); c = kb[a] || kb[a.slice(0, 2)]; if (b === n && !c) throw Error("Invalid locale."); return c || ab }
    function sb(a, b) {
        function c(g) { var m = i[g]; if (C(m)) i[g] = m.split(","); else m || (i[g] = []) } function d(g, m) { g = g.split("+").map(function (o) { return o.replace(/(.+):(.+)$/, function (x, z, J) { return J.split("|").map(function (M) { return z + M }).join("|") }) }).join("|"); return g.split("|").forEach(m) } function e(g, m, o) { var x = []; i[g].forEach(function (z, J) { if (m) z += "+" + z.slice(0, 3); d(z, function (M, Q) { x[Q * o + J] = M.toLowerCase() }) }); i[g] = x } function f(g, m, o) { g = "\\d{" + g + "," + m + "}"; if (o) g += "|(?:" + ob(i.numbers) + ")+"; return g } function h(g,
        m) { i[g] = i[g] || m } var i, j; i = new lb(b); c("modifiers"); "months,weekdays,units,numbers,articles,tokens,timeMarker,ampm,timeSuffixes,dateParse,timeParse".split(",").forEach(c); j = !i.monthSuffix; e("months", j, 12); e("weekdays", j, 7); e("units", n, 8); e("numbers", n, 10); h("code", a); h("date", f(1, 2, i.digitDate)); h("year", "'\\d{2}|" + f(4, 4)); h("num", function () { var g = ["\\d+"].concat(i.articles); if (i.numbers) g = g.concat(i.numbers); return ob(g) }()); (function () {
            var g = []; i.ha = {}; i.modifiers.forEach(function (m) {
                var o = m.name;
                d(m.src, function (x) { var z = i[o]; i.ha[x] = m; g.push({ name: o, src: x, value: m.value }); i[o] = z ? z + "|" + x : x })
            }); i.day += "|" + ob(i.weekdays); i.modifiers = g
        })(); if (i.monthSuffix) { i.month = f(1, 2); i.months = qa(1, 12).map(function (g) { return g + i.monthSuffix }) } i.full_month = f(1, 2) + "|" + ob(i.months); i.timeSuffixes.length > 0 && i.addFormat(pb(cb, i), n, bb); i.addFormat("{day}", k); i.addFormat("{month}" + (i.monthSuffix || "")); i.addFormat("{year}" + (i.yearSuffix || "")); i.timeParse.forEach(function (g) { i.addFormat(g, k) }); i.dateParse.forEach(function (g) { i.addFormat(g) });
        return kb[a] = i
    ...
    function yb(a, b, c, d) {
        var e = new s, f = n, h, i, j, g, m, o, x, z, J; e.utc(d); if (ga(a)) e.utc(a.isUTC()).setTime(a.getTime()); else if (B(a)) e.setTime(a); else if (na(a)) { e.set(a, k); g = a } else if (C(a)) {
            h = rb(b); a = wb(a); h && G(h.ta(), function (M, Q) {
                var Da = a.match(Q.Ca); if (Da) {
                    j = Q; i = j.ya; g = vb(Da, j.to, i); g.utc && e.utc(); i.ma = j; if (g.timestamp) { g = g.timestamp; return n } if (j.Da && !C(g.month) && (C(g.date) || h.wa(b))) { z = g.month; g.month = g.date; g.date = z } if (g.year && g.Ea.length === 2) g.year = O(W(new s, "FullYear") / 100) * 100 - O(g.year / 100) * 100 + g.year;
                    ...
                    12) g.hour += 12; else if (i.za(g.ampm) && g.hour === 12) g.hour = 0; if ("offset_hours" in g || "offset_minutes" in g) { e.utc(); g.offset_minutes = g.offset_minutes || 0; g.offset_minutes += g.offset_hours * 60; if (g.offset_sign === "-") g.offset_minutes *= -1; g.minute -= g.offset_minutes } if (g.unit) {
                        f = k; x = i.oa(g.num); m = i.sa(g.unit); if (g.shift || g.edge) { x *= (z = i.ha[g.shift]) ? z.value : 0; if (m === "month" && L(g.date)) { e.set({ day: g.date }, k); delete g.date } if (m === "year" && L(g.month)) { e.set({ month: g.month, day: g.date }, k); delete g.month; delete g.date } } if (g.sign &&
                        (z = i.ha[g.sign])) x *= z.value; if (L(g.weekday)) { e.set({ weekday: g.weekday }, k); delete g.weekday } g[m] = (g[m] || 0) + x
                    } if (g.year_sign === "-") g.year *= -1; gb.slice(1, 4).forEach(function (U, cc) { var Gb = g[U.$], Hb = Gb % 1; if (Hb) { g[gb[cc].$] = O(Hb * (U.$ === "second" ? 1E3 : 60)); g[U.$] = ra(Gb) } }); return n
                }
            }); if (j) if (f) e.advance(g); else { e._utc && e.reset(); zb(e, g, k, n, c) } else { if (a !== "now") e = new s(a); d && e.addMinutes(-e.getTimezoneOffset()) } if (g && g.edge) {
                z = i.ha[g.edge]; G(gb.slice(4), function (M, Q) { if (L(g[Q.$])) { m = Q.$; return n } }); if (m ===
                "year") g.fa = "month"; else if (m === "month" || m === "week") g.fa = "day"; e[(z.value < 0 ? "endOf" : "beginningOf") + nb(m)](); z.value === -2 && e.reset()
            } J && J(); e.utc(n)
        } return { ea: e, set: g }
    } function mb(a) { var b, c = v.abs(a), d = c, e = 0; gb.slice(1).forEach(function (f, h) { b = ra(O(c / f.da() * 10) / 10); if (b >= 1) { d = b; e = h + 1 } }); return [d, e, a] } function Ab(a) { var b = mb(a.millisecondsFromNow()); if (b[1] === 6) b[0] = v.abs(a.monthsFromNow()); return b }
    function Bb(a, b, c, d) {
        var e, f = rb(d), h = r(/^[A-Z]/); if (a.isValid()) if (Date[b]) b = Date[b]; else { if (A(b)) { e = Ab(a); b = b.apply(a, e.concat(f)) } } else return "Invalid Date"; if (!b && c) { e = e || Ab(a); if (e[1] === 0) { e[1] = 1; e[0] = 1 } return f.va(e) } b = b || "long"; b = f[b] || b; ib.forEach(function (i) {
            b = b.replace(r("\\{(" + i.ba + ")(\\d)?\\}", i.la ? "i" : ""), function (j, g, m) {
                j = i.format(a, f, m || 1, g); m = g.length; var o = g.match(/^(.)\1+$/); if (i.la) { if (m === 3) j = j.slice(0, 3); if (o || g.match(h)) j = nb(j) } else if (o && !i.text) j = (B(j) ? P(j, m) : j.toString()).slice(-m);
                return j
            })
        }); return b
    ...
    function zb(a, b, c, d, e) {
        function f(g) { return L(b[g]) ? b[g] : b[g + "s"] } function h(g) { return L(f(g)) } var i, j; if (B(b) && d) b = { milliseconds: b }; else if (B(b)) { a.setTime(b); return a } if (L(b.date)) b.day = b.date; G(gb, function (g, m) { var o = m.$ === "day"; if (h(m.$) || o && h("weekday")) { b.fa = m.$; j = +g; return n } else if (c && m.$ !== "week" && (!o || !h("week"))) Eb(a, m.method, o ? 1 : 0) }); jb.forEach(function (g) {
            var m = g.$; g = g.method; var o; o = f(m); if (!N(o)) {
                if (d) { if (m === "week") { o = (b.day || 0) + o * 7; g = "Date" } o = o * d + W(a, g) } else m === "month" && h("day") &&
                Eb(a, "Date", 15); Eb(a, g, o); if (d && m === "month") { m = o; if (m < 0) m = m % 12 + 12; m % 12 != W(a, "Month") && Eb(a, "Date", 0) }
            }
        }); if (!d && !h("day") && h("weekday")) { i = f("weekday"); a.setWeekday(i) } (function () { var g = new s; return e === -1 && a > g || e === 1 && a < g })() && G(gb.slice(j + 1), function (g, m) { if ((m.ja || m.$ === "week" && h("weekday")) && !(h(m.$) || m.$ === "day" && h("weekday"))) { a[m.ia](e); return n } }); return a
    } function W(a, b) { return a["get" + (a._utc ? "UTC" : "") + b]() } function Eb(a, b, c) { return a["set" + (a._utc && b != "ISOWeek" ? "UTC" : "") + b](c) }
    ...
    s.extend({
        set: function () { var a = tb(arguments); return zb(this, a[0], a[1]) }, setWeekday: function (a) { if (!N(a)) return Eb(this, "Date", W(this, "Date") + a - W(this, "Day")) }, setISOWeek: function (a) { var b = W(this, "Day") || 7; if (!N(a)) { this.set({ month: 0, date: 4 }); this.set({ weekday: 1 }); a > 1 && this.addWeeks(a - 1); b !== 1 && this.advance({ days: b - 1 }); return this.getTime() } }, getISOWeek: function () { var a = this; a = a.clone(); var b = W(a, "Day") || 7; a.addDays(4 - b).reset(); return 1 + ra(a.daysSince(a.clone().beginningOfYear()) / 7) }, getUTCOffset: function (a) {
            var b =
            this._utc ? 0 : this.getTimezoneOffset(), c = a === k ? ":" : ""; if (!b && a) return "Z"; return P(O(-b / 60), 2, k) + c + P(b % 60, 2)
        }, utc: function (a) { E(this, "_utc", a === k || arguments.length === 0); return this }, isUTC: function () { return !!this._utc || this.getTimezoneOffset() === 0 }, advance: function () { var a = tb(arguments, k); return zb(this, a[0], a[1], 1) }, rewind: function () { var a = tb(arguments, k); return zb(this, a[0], a[1], -1) }, isValid: function () { return !isNaN(this.getTime()) }, isAfter: function (a, b) {
            return this.getTime() > s.create(a).getTime() - (b ||
            0)
        }, isBefore: function (a, b) { return this.getTime() < s.create(a).getTime() + (b || 0) }, isBetween: function (a, b, c) { var d = this.getTime(); a = s.create(a).getTime(); var e = s.create(b).getTime(); b = v.min(a, e); a = v.max(a, e); c = c || 0; return b - c < d && a + c > d }, isLeapYear: function () { var a = W(this, "FullYear"); return a % 4 === 0 && a % 100 !== 0 || a % 400 === 0 }, daysInMonth: function () { return 32 - W(new s(W(this, "FullYear"), W(this, "Month"), 32), "Date") }, format: function (a, b) { return Bb(this, a, n, b) }, relative: function (a, b) {
            if (C(a)) { b = a; a = l } return Bb(this,
            a, k, b)
        }, is: function (a, b, c) { var d, e; if (this.isValid()) { if (C(a)) { a = a.trim().toLowerCase(); e = this.clone().utc(c); switch (k) { case a === "future": return this.getTime() > (new s).getTime(); case a === "past": return this.getTime() < (new s).getTime(); case a === "weekday": return W(e, "Day") > 0 && W(e, "Day") < 6; case a === "weekend": return W(e, "Day") === 0 || W(e, "Day") === 6; case (d = V.weekdays.indexOf(a) % 7) > -1: return W(e, "Day") === d; case (d = V.months.indexOf(a) % 12) > -1: return W(e, "Month") === d } } return Cb(this, a, b, c) } }, reset: function (a) {
            var b =
            {}, c; a = a || "hours"; if (a === "date") a = "days"; c = jb.some(function (d) { return a === d.$ || a === d.$ + "s" }); b[a] = a.match(/^days?/) ? 1 : 0; return c ? this.set(b, k) : this
        }, clone: function () { var a = new s(this.getTime()); a.utc(!!this._utc); return a }
    }); s.extend({ iso: function () { return this.toISOString() }, getWeekday: s.prototype.getDay, getUTCWeekday: s.prototype.getUTCDay });
    ...
    V = ab = s.addLocale("en", {
        ...
        past: "{num} {unit} {sign}", future: "{num} {unit} {sign}", duration: "{num} {unit}", modifiers: [{ name: "day", src: "yesterday", value: -1 }, { name: "day", src: "today", value: 0 }, { name: "day", src: "tomorrow", value: 1 }, { name: "sign", src: "ago|before", value: -1 }, { name: "sign", src: "from now|after|from|in|later", value: 1 }, { name: "edge", src: "last day", value: -2 }, { name: "edge", src: "end", value: -1 }, { name: "edge", src: "first day|beginning", value: 1 }, { name: "shift", src: "last", value: -1 }, { name: "shift", src: "the|this", value: 0 }, {
            name: "shift",
            src: "next", value: 1
        }], dateParse: ["{num} {unit} {sign}", "{sign} {num} {unit}", "{month} {year}", "{shift} {unit=5-7}", "{0?} {date}{1}", "{0?} {edge} of {shift?} {unit=4-7?}{month?}{year?}"], timeParse: ["{0} {num}{1} {day} of {month} {year?}", "{weekday?} {month} {date}{1?} {year?}", "{date} {month} {year}", "{date} {month}", "{shift} {weekday}", "{shift} week {weekday}", "{weekday} {2?} {shift} week", "{num} {unit=4-5} {sign} {day}", "{0?} {date}{1} of {month}", "{0?}{month?} {date?}{1?} of {shift} {unit=6-7}"]
    });
    gb = jb.concat().reverse(); fb = jb.concat(); fb.splice(2, 1);
    I(s, k, n, jb, function (a, b, c) {
        function d(g) { g = g / h; var m = g % 1, o = b.error || 0.999; if (m && v.abs(m % 1) > o) g = O(g); return parseInt(g) } var e = b.$, f = nb(e), h = b.da(), i, j; b.ia = "add" + f + "s"; i = function (g, m) { return d(this.getTime() - s.create(g, m).getTime()) }; j = function (g, m) { return d(s.create(g, m).getTime() - this.getTime()) }; a[e + "sAgo"] = j; a[e + "sUntil"] = j; a[e + "sSince"] = i; a[e + "sFromNow"] = i; a[b.ia] = function (g, m) { var o = {}; o[e] = g; return this.advance(o, m) }; Fb(b, h); c < 3 && ["Last", "This", "Next"].forEach(function (g) {
            a["is" + g + f] = function () {
                return this.is(g +
                " " + e)
            }
        }); if (c < 4) { a["beginningOf" + f] = function () { var g = {}; switch (e) { case "year": g.year = W(this, "FullYear"); break; case "month": g.month = W(this, "Month"); break; case "day": g.day = W(this, "Date"); break; case "week": g.weekday = 0 } return this.set(g, k) }; a["endOf" + f] = function () { var g = { hours: 23, minutes: 59, seconds: 59, milliseconds: 999 }; switch (e) { case "year": g.month = 11; g.day = 31; break; case "month": g.day = this.daysInMonth(); break; case "week": g.weekday = 6 } return this.set(g, k) } }
    });
    ...
    F(DateRange, k, n, {
        isValid: function () { return this.start < this.end }, duration: function () { return this.isValid() ? this.end.getTime() - this.start.getTime() : NaN }, contains: function (a) { var b = this; return (a.start && a.end ? [a.start, a.end] : [a]).every(function (c) { return c >= b.start && c <= b.end }) }, every: function (a, b) {
            var c = this.start.clone(), d = [], e = 0, f, h; if (C(a)) { c.advance(ub(a, 0), k); f = ub(a); h = a.toLowerCase() === "day" } else f = { milliseconds: a }; for (; c <= this.end;) {
                d.push(c); b && b(c, e); if (h && W(c, "Hours") === 23) {
                    c = c.clone(); Eb(c,
                    "Hours", 48)
                } else c = c.clone().advance(f, k); e++
            } return d
        }, union: function (a) { return new DateRange(this.start < a.start ? this.start : a.start, this.end > a.end ? this.end : a.end) }, intersect: function (a) { return new DateRange(this.start > a.start ? this.start : a.start, this.end < a.end ? this.end : a.end) }, clone: function () { return new DateRange(this.start, this.end) }
    }); I(DateRange, k, n, "Millisecond,Second,Minute,Hour,Day,Week,Month,Year", function (a, b) { a["each" + b] = function (c) { return this.every(b, c) } });
    ...
    F(Function, k, n, {
        lazy: function (a, b) { function c() { if (!f || e.length < b - 1) { e.push([this, arguments]); h() } return g } var d = this, e = [], f = n, h, i, j, g; a = a || 1; b = b || Infinity; i = O(a, void 0, "ceil"); j = O(i / a) || 1; h = function () { if (!(f || e.length == 0)) { for (var m = v.max(e.length - j, 0) ; e.length > m;) g = Function.prototype.apply.apply(d, e.shift()); Ib(c, i, function () { f = n; h() }); f = k } }; return c }, delay: function (a) { var b = K(arguments).slice(1); Ib(this, a, this, this, b); return this }, throttle: function (a) { return this.lazy(a, 1) }, debounce: function (a) {
            function b() {
                b.cancel();
                Ib(b, a, c, this, arguments)
            } var c = this; return b
        }, cancel: function () { if (ea(this.timers)) for (; this.timers.length > 0;) clearTimeout(this.timers.shift()); return this }, after: function (a) { var b = this, c = 0, d = []; if (B(a)) { if (a === 0) { b.call(); return b } } else a = 1; return function () { var e; d.push(K(arguments)); c++; if (c == a) { e = b.call(this, d); c = 0; d = []; return e } } }, once: function () { return this.throttle(Infinity) }, fill: function () {
            var a = this, b = K(arguments); return function () {
                var c = K(arguments); b.forEach(function (d, e) {
                    if (d != l || e >=
                    c.length) c.splice(e, 0, d)
    ...
    F(u, k, n, {
        log: function (a) { return v.log(this) / (a ? v.log(a) : 1) }, abbr: function (a) { return Jb(this, a, "kmbt", 0, 4) }, metric: function (a, b) { return Jb(this, a, "n\u03bcm kMGTPE", 4, N(b) ? 1 : b) }, bytes: function (a, b) { return Jb(this, a, "kMGTPE", 0, N(b) ? 4 : b, k) + "B" }, isInteger: function () { return this % 1 == 0 }, isOdd: function () { return !isNaN(this) && !this.isMultipleOf(2) }, isEven: function () { return this.isMultipleOf(2) }, isMultipleOf: function (a) { return this % a === 0 }, format: function (a, b, c) {
            var d, e, f, h = ""; if (N(b)) b = ","; if (N(c)) c = "."; d = (B(a) ?
            O(this, a || 0).toFixed(v.max(a, 0)) : this.toString()).replace(/^-/, "").split("."); e = d[0]; f = d[1]; for (d = e.length; d > 0; d -= 3) { if (d < e.length) h = b + h; h = e.slice(v.max(0, d - 3), d) + h } if (f) h += c + sa((a || 0) - f.length, "0") + f; return (this < 0 ? "-" : "") + h
        }, hex: function (a) { return this.pad(a || 1, n, 16) }, upto: function (a, b, c) { return qa(this, a, b, c || 1) }, downto: function (a, b, c) { return qa(this, a, b, -(c || 1)) }, times: function (a) { if (a) for (var b = 0; b < this; b++) a.call(this, b); return this.toNumber() }, chr: function () { return t.fromCharCode(this) }, pad: function (a,
        b, c) { return P(this, a, b, c) }, ordinalize: function () { var a = this.abs(); a = parseInt(a.toString().slice(-2)); return this + ta(a) }, toNumber: function () { return parseFloat(this, 10) }
    }); I(u, k, n, "round,floor,ceil", function (a, b) { a[b] = function (c) { return O(this, c, b) } }); I(u, k, n, "abs,pow,sin,asin,cos,acos,tan,atan,exp,pow,sqrt", function (a, b) { a[b] = function (c, d) { return v[b](this, c, d) } });
    ...
    F(p, n, n, {
        isObject: function (a) { return na(a) }, isNaN: function (a) { return B(a) && a.valueOf() !== a.valueOf() }, equal: function (a, b) { return xa(a) && xa(b) ? wa(a) === wa(b) : a === b }, extended: function (a) { return new pa(a) }, merge: function (a, b, c, d) {
            var e, f; if (a && typeof b != "string") for (e in b) if (H(b, e) && a) {
                f = b[e]; if (L(a[e])) { if (d === n) continue; if (A(d)) f = d.call(b, e, a[e], b[e]) } if (c === k && f && ma(f)) if (ga(f)) f = new s(f.getTime()); else if (D(f)) f = new r(f.source, va(f)); else { a[e] || (a[e] = q.isArray(f) ? [] : {}); p.merge(a[e], b[e], c, d); continue } a[e] =
                f
            } return a
        }, values: function (a, b) { var c = []; G(a, function (d, e) { c.push(e); b && b.call(a, e) }); return c }, clone: function (a, b) { var c; if (ga(a) && a.clone) return a.clone(); else if (ma(a)) c = a instanceof pa ? new pa : new a.constructor; else return a; return p.merge(c, a, b) }, fromQueryString: function (a, b) { var c = p.extended(); a = a && a.toString ? a.toString() : ""; a.replace(/^.*?\?/, "").split("&").forEach(function (d) { d = d.split("="); d.length === 2 && Mb(c, d[0], decodeURIComponent(d[1]), b) }); return c }, tap: function (a, b) {
            var c = b; A(b) || (c =
            function () { b && a[b]() }); c.call(a, a); return a
        }, has: function (a, b) { return H(a, b) }, select: function (a) { return Nb(a, arguments, k) }, reject: function (a) { return Nb(a, arguments, n) }
    }); I(p, n, n, w, function (a, b) { var c = "is" + b; Kb.push(c); a[c] = ca[b] }); (function () { F(p, n, function () { return arguments.length === 0 }, { extend: function () { var a = Kb.concat(Lb); if (typeof $a !== "undefined") a = a.concat($a); za(a, p) } }) })(); za(Lb, pa);
    ...
    F(t, k, n, {
        escapeRegExp: function () { return R(this) }, escapeURL: function (a) { return a ? encodeURIComponent(this) : encodeURI(this) }, unescapeURL: function (a) { return a ? decodeURI(this) : decodeURIComponent(this) }, escapeHTML: function () { return this.replace(/&/g, "&amp;").replace(/</g, "&lt;").replace(/>/g, "&gt;").replace(/"/g, "&quot;").replace(/'/g, "&apos;").replace(/\//g, "&#x2f;") }, unescapeHTML: function () {
            return this.replace(/&lt;/g, "<").replace(/&gt;/g, ">").replace(/&quot;/g, '"').replace(/&apos;/g, "'").replace(/&#x2f;/g,
            "/").replace(/&amp;/g, "&")
        }, encodeBase64: function () { return Ob(this) }, decodeBase64: function () { return Pb(this) }, each: function (a, b) { var c, d, e; if (A(a)) { b = a; a = /[\s\S]/g } else if (a) if (C(a)) a = r(R(a), "gi"); else { if (D(a)) a = r(a.source, va(a, "g")) } else a = /[\s\S]/g; c = this.match(a) || []; if (b) { d = 0; for (e = c.length; d < e; d++) c[d] = b.call(this, c[d], d, c) || c[d] } return c }, shift: function (a) { var b = ""; a = a || 0; this.codes(function (c) { b += t.fromCharCode(c + a) }); return b }, codes: function (a) {
            var b = [], c, d; c = 0; for (d = this.length; c < d; c++) {
                var e =
                this.charCodeAt(c); b.push(e); a && a.call(this, e, c)
            } return b
        ...
        remove: function (a) { return this.replace(a, "") }, reverse: function () { return this.split("").reverse().join("") }, compact: function () { return this.trim().replace(/([\r\n\s\u3000])+/g, function (a, b) { return b === "\u3000" ? b : " " }) }, at: function () { return ya(this, arguments, k) }, from: function (a) { return this.slice(a) }, to: function (a) { if (N(a)) a = this.length; return this.slice(0, a) }, dasherize: function () { return this.underscore().replace(/_/g, "-") }, underscore: function () {
            return this.replace(/[-\s]+/g, "_").replace(t.Inflector &&
            t.Inflector.acronymRegExp, function (a, b) { return (b > 0 ? "_" : "") + a.toLowerCase() }).replace(/([A-Z\d]+)([A-Z][a-z])/g, "$1_$2").replace(/([a-z\d])([A-Z])/g, "$1_$2").toLowerCase()
        }, camelize: function (a) { return this.underscore().replace(/(^|_)([^_]+)/g, function (b, c, d, e) { b = d; b = (c = t.Inflector) && c.acronyms[b]; b = C(b) ? b : void 0; e = a !== n || e > 0; if (b) return e ? b : b.toLowerCase(); return e ? d.capitalize() : d }) }, spacify: function () { return this.underscore().replace(/_/g, " ") }, stripTags: function () {
            var a = this; ka(arguments.length >
            0 ? arguments : [""], function (b) { a = a.replace(r("</?" + R(b) + "[^<>]*>", "gi"), "") }); return a
        }, removeTags: function () { var a = this; ka(arguments.length > 0 ? arguments : ["\\S+"], function (b) { b = r("<(" + b + ")[^<>]*(?:\\/>|>.*?<\\/\\1>)", "gi"); a = a.replace(b, "") }); return a }, truncate: function (a, b, c, d) {
            var e = "", f = "", h = this.toString(), i = "[" + ua() + "]+", j = "[^" + ua() + "]*", g = r(i + j + "$"); d = N(d) ? "..." : t(d); if (h.length <= a) return h; switch (c) {
                case "left": a = h.length - a; e = d; h = h.slice(a); g = r("^" + j + i); break; case "middle": a = ra(a / 2); f = d + h.slice(h.length -
                a).trimLeft(); h = h.slice(0, a); break; default: a = a; f = d; h = h.slice(0, a)
            } if (b === n && this.slice(a, a + 1).match(/\S/)) h = h.remove(g); return e + h + f
        }, pad: function (a, b) { return sa(b, a) + this + sa(b, a) }, padLeft: function (a, b) { return sa(b, a) + this }, padRight: function (a, b) { return this + sa(b, a) }, first: function (a) { if (N(a)) a = 1; return this.substr(0, a) }, last: function (a) { if (N(a)) a = 1; return this.substr(this.length - a < 0 ? 0 : this.length - a) }, repeat: function (a) { var b = "", c = this; if (!B(a) || a < 1) return ""; for (; a;) { if (a & 1) b += c; if (a >>= 1) c += c } return b },
    ...
    (function (a) {
        if (this.btoa) { Ob = this.btoa; Pb = this.atob } else {
            var b = /[^A-Za-z0-9\+\/\=]/g; Ob = function (c) { var d = "", e, f, h, i, j, g, m = 0; do { e = c.charCodeAt(m++); f = c.charCodeAt(m++); h = c.charCodeAt(m++); i = e >> 2; e = (e & 3) << 4 | f >> 4; j = (f & 15) << 2 | h >> 6; g = h & 63; if (isNaN(f)) j = g = 64; else if (isNaN(h)) g = 64; d = d + a.charAt(i) + a.charAt(e) + a.charAt(j) + a.charAt(g) } while (m < c.length); return d }; Pb = function (c) {
                var d = "", e, f, h, i, j, g = 0; if (c.match(b)) throw Error("String contains invalid base64 characters"); c = c.replace(/[^A-Za-z0-9\+\/\=]/g, "");
                do { e = a.indexOf(c.charAt(g++)); f = a.indexOf(c.charAt(g++)); i = a.indexOf(c.charAt(g++)); j = a.indexOf(c.charAt(g++)); e = e << 2 | f >> 4; f = (f & 15) << 4 | i >> 2; h = (i & 3) << 6 | j; d += t.fromCharCode(e); if (i != 64) d += t.fromCharCode(f); if (j != 64) d += t.fromCharCode(h) } while (g < c.length); return d
            }
        }
